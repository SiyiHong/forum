    ...
    <ul class="nav nav-tabs">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <li style="float:right"><a href="${pageContext.request.contextPath}/publish.jsp">发布</a></li>
                <li style="float:right"><a href="${pageContext.request.contextPath}/reply.jsp?topic_id=${param.topic_id}">回复</a></li>
            </c:otherwise>
        </c:choose>
    </ul>
...
<%--                </td>--%>
    ...
    <ul class="pagination">
        ...
        <c:if test="${replyPage.totalPage>0}">
            <c:forEach var="i" begin="1" end="${replyPage.totalPage}" step="1">
                <li>
                    <a href="${pageContext.request.contextPath}/topic?method=findDetailById&topic_id=${param.topic_id}&page=${i}">${i}</a>
                </li>
            </c:forEach>
        </c:if>
